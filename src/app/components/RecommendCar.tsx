...
const RecommendCar = () => {
   const carDetails=[
       ...
       return(
           <div className="flex sm:flex-row md:flex-col lg:flex-col w-[1112px] h-[452px]">
            <h2 className="font-plusJakartaSans font-semibold pl-[56px] text-[16px] text-[#90A3BF]">Recommended Cars</h2> 
           <div className="flex justify-center w-[1100px] pt-[10px]">
           </div>
              ...
              <Link href="/DetailsPage"><button className="ml-[496px] bg-[#3563E9] text-[#FFFFFF] h-[42px] py-[8px] px-[8px] rounded-md">
                Show more Cars
               </button></Link>
           </div>
