...
const HeroSection = ()  => {
    return(
            ...
            <button className="w-[120px] h-[36px] mt-[20px] pr-[16px] pl-[16px] rounded-[2px] text-[#F5F5F5] bg-[#3563E9]">Rental Car</button>
             <Image src="/image 7.png" alt="car" width={500} height={400} className="pl-[90px] pr-[30px]"/>
              </div>  
    
            <div className=" bg-[#3563E9] w-[640px] h-[320px] pt-[24px] pl-[24px] border-2 rounded-[8px]">
                ...
                <Image src="/image 8.png" alt="car" width={400} height={200} className="pl-[90px] pr-[30px]"/>
                 </div>
            </div>
    )
}
